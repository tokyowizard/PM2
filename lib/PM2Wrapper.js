...
function PM2(options) {
  ...
  // duplicate events from the interface here
  self._interface.emit = function() {
    EE.prototype.emit.apply(self._interface, arguments)
    EE.prototype.emit.apply(self, arguments)
  }
